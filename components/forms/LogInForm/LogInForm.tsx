    ...
    >
      {({ handleChange, handleBlur, handleSubmit, values }) => (
        <View>
          ...
          <TouchableOpacity
            style={tw`mt-8 w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500`}
